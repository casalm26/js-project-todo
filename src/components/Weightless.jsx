...
// git this component from https://www.thewayofcode.com/#1
...
const HankiesInTheWind = ({ initialZoom = 6, lineColor = 0x333333, backgroundColor = '#F0EEE6' }) => {
  ...
  }, [currentZoom, lineColor, backgroundColor])
